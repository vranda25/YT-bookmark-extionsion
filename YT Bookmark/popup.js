...
const setBookmarkAttributes = (src, eventListener, controlParentElement) => {
    const contolElement = document.createElement("img");

    contolElement.src = "assets/" + src + ".png";
    contolElement.title = src;
    contolElement.addEventListener("click", eventListener);
    controlParentElement.appendChild(contolElement);
};
